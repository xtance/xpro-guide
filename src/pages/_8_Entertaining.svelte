...
<Subtitle>Исследуйте открытый мир сервера на <Key>Esc</Key> карте,</Subtitle>
<Subtitle>изучайте возможности сервера в <Key>M</Key> Планшете,</Subtitle>
<Subtitle>общайтесь с другими игроками в <Key>T</Key> чате,</Subtitle>
<Subtitle>и открывайте для себя новые занятия.</Subtitle>
